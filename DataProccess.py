...
class DataProccess:
        ...
        @classmethod
        def return_proccessed_data_multiclass(self):
                """
                ...
                numericalized_train_data_results = [self.numericalize_result(x,attack,attack_dict) for x in raw_train_data_results]
