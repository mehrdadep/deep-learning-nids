...
predictions = Dense(7, name='prediction_layer', activation='softmax')(final)
...
start = time.time()
model.fit([x_train,x_train,x_train], y_train, validation_data=([x_test,x_test,x_test], y_test), epochs=10, batch_size=64)
